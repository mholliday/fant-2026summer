...
const OSTEOMETRY_FIELDS = {
  ...
  humerus: [
    ...
    { key: "humerus_head_diameter",      label: "Head Diameter (HDD)",                  unit: "mm" },
  ...
  femur: [
    ...
    { key: "femur_head_diameter",        label: "Head Diameter (HDD)",                  unit: "mm" },
    { key: "femur_ap_subtrochanteric",   label: "A-P Subtrochanteric Diameter (SAP)",   unit: "mm" },
    { key: "femur_ml_subtrochanteric",   label: "M-L Subtrochanteric Diameter (STV)",   unit: "mm" },
    { key: "femur_ap_midshaft",          label: "A-P Midshaft Diameter (MAP)",          unit: "mm" },
    { key: "femur_ml_midshaft",          label: "M-L Midshaft Diameter (MTV)",          unit: "mm" },
  ...
  tibia: [
    ...
    { key: "tibia_ap_nutrient_foramen",  label: "A-P Diameter at Nutrient Foramen (NFX)",unit: "mm" },
    { key: "tibia_ml_nutrient_foramen",  label: "M-L Diameter at Nutrient Foramen (NFT)",unit: "mm" },
...
const defaultSkeleton = () => {
  const s = { recorder: "", date: "", comments: "" };
      ...
      <Form onSubmit={handleSubmit}>
        ...
        <Card className="mb-3">
          <Card.Header onClick={() => toggle("identification")} style={{ cursor: "pointer", userSelect: "none" }} className="d-flex justify-content-between align-items-center">
            <strong>Identification</strong><span className="text-muted">{open.identification ? "▲" : "▼"}</span>
          </Card.Header>
        ...
        <Card className="mb-3">
          ...
          <Card.Body>
            ...
            <div className="row g-2 mb-3">
              <div className="col-md-4">
                <Form.Group>
                  <Form.Label className="small mb-1">Recorder</Form.Label>
                  <Form.Control size="sm" value={skeleton.recorder ?? ""} onChange={e => handleSkeletonChange("recorder", e.target.value)} />
                </Form.Group>
              </div>
              <div className="col-md-3">
                <Form.Group>
                  <Form.Label className="small mb-1">Date</Form.Label>
                  <Form.Control size="sm" type="date" value={skeleton.date ?? ""} onChange={e => handleSkeletonChange("date", e.target.value)} />
                </Form.Group>
              </div>
            </div>
        ...
        {/* Notes */}
        <Card className="mb-3">
          <Card.Header onClick={() => toggle("notes")} style={{ cursor: "pointer", userSelect: "none" }} className="d-flex justify-content-between align-items-center">
            <strong>Notes</strong><span className="text-muted">{open.notes ? "▲" : "▼"}</span>
          </Card.Header>
          <Collapse in={open.notes}><div>
          <Card.Body>
            <Form.Group className="mb-3">
              <Form.Label>General Observations</Form.Label>
              <Form.Control as="textarea" rows={4} value={notes.general_observations} onChange={(e) => handleNotesChange("general_observations", e.target.value)} />
            </Form.Group>
            <Form.Group>
              <Form.Label>Trauma and Pathological Analysis</Form.Label>
              <Form.Control as="textarea" rows={4} value={notes.trauma_and_pathological_analysis} onChange={(e) => handleNotesChange("trauma_and_pathological_analysis", e.target.value)} />
            </Form.Group>
          </Card.Body>
          </div></Collapse>
        </Card>
